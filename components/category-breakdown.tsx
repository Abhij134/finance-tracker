    ...
    >
      ...
      <div className="relative" style={{ width: "100%", height: isMobile ? 280 : 320 }}>
        ...
        <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
          <span className="text-[9px] uppercase tracking-[0.15em] text-zinc-400 font-semibold">
          ...
          <span className="mt-1 sm:mt-1.5 text-[8px] sm:text-[9px] uppercase tracking-widest text-zinc-400">
            Total
          </span>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar mt-1 pr-1 flex flex-col gap-2" tabIndex={0}>
        {data.map((d, i) => {
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <ChevronDown
                      className={`h-3.5 w-3.5 text-zinc-400 transition-transform duration-300 group-hover:text-zinc-400 ${isExpanded ? "rotate-180 text-emerald-400" : ""
                        }`}
                    />
                  </div>
                </div>
                ...
                {isExpanded && (
                  ...
                  >
                    ...
                    <div className="mx-2 mb-2 rounded-xl border border-white/[0.06] bg-white/[0.04] backdrop-blur-md overflow-hidden">
                      ...
                      {/* Transaction rows */}
                      <div className="divide-y divide-white/[0.04] max-h-[200px] overflow-y-auto custom-scrollbar" tabIndex={0}>
                        {d.txs.map((tx, txIdx) => (
                          <motion.div
                            key={tx.id || txIdx}
